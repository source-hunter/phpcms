...
'cookie_pre' => 'EipHE_', //Cookie 前缀，同一域名下安装多套系统时，请修改Cookie前缀
...
'upload_url' => 'http://10.211.55.3/phpcms/uploadfile/', //附件路径
'attachment_stat' => '1',//是否记录附件使用状态 0 统计 1 统计， 注意: 本功能会加重服务器负担

'js_path' => 'http://10.211.55.3/phpcms/statics/js/', //CDN JS
'css_path' => 'http://10.211.55.3/phpcms/statics/css/', //CDN CSS
'img_path' => 'http://10.211.55.3/phpcms/statics/images/', //CDN img
'app_path' => 'http://10.211.55.3/phpcms/',//动态域名配置地址
...
'gzip' => 1, //是否Gzip压缩后输出
'auth_key' => '0gvzdgs7IDkCt1qsGRC6', //密钥
'lang' => 'zh-cn',  //网站语言包
...
'phpsso' => '1',	//是否使用phpsso
'phpsso_appid' => '1',	//应用id	
'phpsso_api_url' => 'http://10.211.55.3/phpcms/phpsso_server',	//接口地址
'phpsso_auth_key' => 'r5VdBgk9r0DTBBQoxez7zWdfqlgEUGhA', //加密密钥
