...
?>   
	...
	<td align="center"> 
 	<a href="javascript:confirmurl('index.php?m=video&c=video&a=sub_del&id=<?php echo $info['sid']?>&meunid=<?php echo $_GET['menuid']?>&type=1', 'ÊÇ·ñÉ¾³ý?')"><?php echo L('delete');?></a></td>
	</tr>
<?php 
	}
}
...
?>   
	...
	<td align="center"> 
 	<a href="javascript:confirmurl('index.php?m=video&c=video&a=user_sub_del&id=<?php echo $val['sid']?>&meunid=<?php echo $_GET['menuid']?>&type=2', 'ÊÇ·ñÉ¾³ý?')"><?php echo L('delete');?></a></td>
	</tr>
<?php 
	}
}
